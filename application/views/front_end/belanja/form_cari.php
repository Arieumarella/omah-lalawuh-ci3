            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <?php }else{ ?>
                        ...
                        <h5>
                        <br>
                         <b><i class="fa fa-search-minus" aria-hidden="true"></i> Barang Tidak Di Temukan</b>
                         </h5>
                         <br>
                         <a class="btn btn-success" href="<?php echo base_url(); ?>front_end/home" role="button">Kembali</a>     
                        </div>
