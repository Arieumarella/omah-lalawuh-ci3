...
<div class="wrapper">
  ...
  <!-- Navbar -->
<?php $this->load->view('back-end/header');?>
  <!-- /.navbar -->

  <!-- Main Sidebar Container -->
<?php $this->load->view('back-end/sidebar');?>
...
<?php $this->load->view($contents);?>
  ...
  <!-- /.content-wrapper -->
<?php $this->load->view('back-end/footer');?>
    ...
    <script type="text/javascript">
        $(function () {
                CKEDITOR.replace('ckeditor',{
                    filebrowserImageBrowseUrl : '<?php echo base_url('assets/editor/kcfinder/browse.php');?>',
                    height: '400px'             
                });
            });
    </script>
